...
<body>
    <div class="container">
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<div class='assessment-box'>";
            echo "<h3>Key Assessments - Autumn Term 1</h3>";
            echo "<p class='editable' data-id='{$row["id"]}' data-field='key_assessments_au1'>" . ($row["key_assessments_au1"]) . "</p>";
            echo "</div>";

            echo "<div class='assessment-box'>";
            echo "<h3>Key Assessments - Autumn Term 2</h3>";
            echo "<p class='editable' data-id='{$row["id"]}' data-field='key_assessments_au2'>" . ($row["key_assessments_au2"]) . "</p>";
            echo "</div>";

            echo "<div class='assessment-box'>";
            echo "<h3>Key Assessments - Spring Term 1</h3>";
            echo "<p class='editable' data-id='{$row["id"]}' data-field='key_assessments_sp1'>" . ($row["key_assessments_sp1"]) . "</p>";
            echo "</div>";

            echo "<div class='assessment-box'>";
            echo "<h3>Key Assessments - Spring Term 2</h3>";
            echo "<p class='editable' data-id='{$row["id"]}' data-field='key_assessments_sp2'>" . ($row["key_assessments_sp2"]) . "</p>";
            echo "</div>";

            echo "<div class='assessment-box'>";
            echo "<h3>Key Assessments - Summer Term 1</h3>";
            echo "<p class='editable' data-id='{$row["id"]}' data-field='key_assessments_su1'>" . ($row["key_assessments_su1"]) . "</p>";
            echo "</div>";

            echo "<div class='assessment-box'>";
            echo "<h3>Key Assessments - Summer Term 2</h3>";
            echo "<p class='editable' data-id='{$row["id"]}' data-field='key_assessments_su2'>" . ($row["key_assessments_su2"]) . "</p>";
            echo "</div>";
